 ...
 * 获取微信 access_token
 */
WeChat.prototype.getAccessToken1 = function(){
    var that = this;
    return new Promise(function(resolve,reject){
        //获取当前时间
...
WeChat.prototype.getAccessToken = function(){
    ...
    return that.request(option).then(function(data){
...
//推送模板消息
WeChat.prototype.sendTemplateMessage = function(){
    var that = this;
    var url = util.format(that.apiURL.templateMessageApi, that.apiDomain, accessTokenJson.access_token);
    var option = {
        url: url,
        method: "POST",
        json: true,
